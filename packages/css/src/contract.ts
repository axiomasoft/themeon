...
export const CSS_CONTRACT: readonly CssContractEntry[] = [
  ...
  { varName: '--color-text', fallback: 'oklch(0.25 0.01 260)', usedBy: ['base'] },
  ...
  { varName: '--color-link-hover', fallback: 'oklch(0.4 0.17 260)', usedBy: ['base'] },
  { varName: '--color-border', fallback: 'oklch(0.85 0.01 260)', usedBy: ['base'] },
